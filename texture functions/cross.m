function [texture, profile] = cross(n_substrate, n_pillar, n_background, height, major_width, minor_width, varargin)
    %CROSS Generate texture and profile for cross-shaped pillars or holes
